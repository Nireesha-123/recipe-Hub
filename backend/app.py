...
SENDER_EMAIL = '224g1a0562@srit.ac.in' # Your Gmail address
SENDER_PASSWORD = 'bkjf amqz phge qdre' # Your Gmail App Password (NOT your regular password if 2FA is on)
RECEIVER_EMAIL = '224g1a0562@srit.ac.in' # The email address where you want to receive feedback
